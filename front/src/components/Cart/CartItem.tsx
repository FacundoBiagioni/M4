                    ...
                    <div className="grid sm:grid-cols-2 items-center gap-4">
                        ...
                        <div className="bg-gradient-to-tr from-gray-300 via-gray-100 rounded-md to-gray-50 w-full h-full p-4 shrink-0 text-center">
                            <Link href={`/product/${product.id}`}>
                                <img className="w-40" src={product.image} alt="Product image" />    
                            </Link>
                        </div>
                        ...
                        <div className="p-2">
                            ...
                            <p className="text-sm text-gray-500 space-y-2 list-disc pl-4 mt-3">
                            {product.description}
                            </p>
                            ...
                            <div className="flex items-center justify-between flex-wrap gap-4 mt-6">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-gray-700">${product.price}</h4>
                                </div>
                            </div>
