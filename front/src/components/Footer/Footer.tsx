...
<footer className="p-4 sm:p-6 bg-gray-100 w-full ">
    <div className="mx-auto max-w-screen-xl ">
        <div className="md:flex md:justify-center">
            <div className="mb-6 md:mb-0">
                <a href="" className="flex items-center">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" className="mr-3 h-8" alt="Apple Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-black">Apple</span>
                </a>
            </div>
        </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between ">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 Apple™ .All Rights Reserved.
            </span>
