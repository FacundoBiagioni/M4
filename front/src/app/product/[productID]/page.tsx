            ...
            <div className="p-4 lg:max-w-7xl max-w-4xl mx-auto">
                <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6 rounded-lg">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex space-x-2 mt-4">
                            <div>
                                <h4 className="mb-6 text-gray-500 dark:text-gray-400">available ({product.stock})</h4>
                            </div>
                        </div>
                ...
                <div className="mt-16 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6">
                    ...
                    <ul className="mt-4 space-y-6 text-gray-800">
                        ...
                        <li className="text-sm">RAM <span className="ml-4 float-right">16 GB</span></li>
                        <li className="text-sm">SSD <span className="ml-4 float-right">1000 GB</span></li>
                        ...
                        <li className="text-sm">DISPLAY SIZE CM <span className="ml-4 float-right">40.64 cm</span></li>
